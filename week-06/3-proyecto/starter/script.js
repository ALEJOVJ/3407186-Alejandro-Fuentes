...
const items = [
  ...
  { name: "Camiseta Niño Spider", category: "camisetas", value: 45 },
  { name: "Vestido Princesa", category: "vestidos", value: 80 },
  { name: "Pantalón Jeans Niño", category: "pantalones", value: 60 },
  { name: "Zapatos Deportivos", category: "calzado", value: 90 },
  { name: "Camiseta Unicornio", category: "camisetas", value: 50 },
  { name: "Sandalias Niña", category: "calzado", value: 35 }
];

// TODO: Define las categorías relevantes para tu dominio
// (ej: para Biblioteca sería ["ficción", "no-ficción", "ciencia"])
const categories = ["camisetas", "vestidos", "pantalones", "calzado"
