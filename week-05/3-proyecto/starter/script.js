...
const elementName = "camiseta de niño spider";          // TODO: nombre del elemento (string)
const elementStatus = "active";                         // TODO: estado actual (string: "active", "inactive", etc.)
const elementValue = 75;                                // TODO: valor numérico para clasificar (ocupación, stock, puntaje…)
const elementType = "camiseta";                         // TODO: tipo o categoría (string)
const elementInfo = {                        
  detail: "Algodón 100% - Talla M",
  color: "Rojo"
...
let classification; // TODO: implementar if/else if/else
if (elementValue >= 70) {
  classification = "Producto de alta demanda";
} else if (elementValue >= 40) {
  classification = "Producto de demanda media";
} else {
  classification = "Producto de baja demanda";
}
...
const infoDetail = elementInfo?.detail ?? "Sin informacion adicional";       // TODO: elementInfo?.detail ?? "Sin información adicional"
