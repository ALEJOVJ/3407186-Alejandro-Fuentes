...
const itemQuantity = 35; // reemplaza 0 con el número adecuado
...
const supplierValue = null; // cambia el nombre a algo de tu dominio
...
console.log("typeof isItemAvialable",typeof isItemAvailable)
console.log("");
